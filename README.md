...
[ConvSensus](http://176.125.254.131/) - система автоматического анализа компьютерной томографии органов грудной клетки, использующая SoTA CNN модели для выявления патологий, включая COVID-19, пневмонию и т.д.
